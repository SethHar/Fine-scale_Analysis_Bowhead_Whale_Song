...
---
**Bowhead_Whale_Song_Analysis.R** includes the random forest analysis, principal component analysis, Levenshtein Similarity Indexes (LSIs) and Dice's Similarity Indexes (DSIs) ran during this study. In order to run LSIs and DSIs you will need three versions of the same file (stored in **SongString** folder): 
