...
MATLAB and R code for 'Fine-scale quantitative analysis of bowhead whale (Balaena mysticetus) song shows varying stability of song types'. MATLAB code written by Luke Rendell and R code written by Seth Harris. All acoustic data and respective Raven selection tables stored in SoundFiles_and_SelctionTables.
